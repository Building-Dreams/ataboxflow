# Nieuwe Aansluiting Interface

Dit project bevat een eenvoudige browserinterface voor het selecteren en behandelen van FTTH-aanvragen.
...
Voor het bijwerken van de inbox kun je een `.xlsx`, `.xls` of `.csv` uploaden. De kolomnamen mogen lijken op:
